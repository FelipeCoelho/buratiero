...
public abstract class ConfirmAjaxButtonCustom<T> extends GenericPanel<String>
{
    ...
    */
   public ConfirmAjaxButtonCustom(final String id, final String label, final String title,
    ...
    * @param message the dialog message
    */
   public ConfirmAjaxButtonCustom(final String id, final IModel<String> label,
      final IModel<String> title, final IModel<String> message)
   {
      super(id, message);
    ...
    */
   protected AbstractFormDialog<?> newFormDialog(final String id, final IModel<String> title,
