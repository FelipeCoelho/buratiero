package br.com.buratiero.pages.ui.provider;
...
public class ProviderGrid extends ListDataProvider<Processo> implements ISortStateLocator<String>
{
   ...
   public ProviderGrid(final List<Processo> listaPessoa)
   {
      super(listaPessoa);
   }

   @Override
   protected List<Processo> getData()
   {
      final List<Processo> list = super.getData();
   ...
   static class ProductComparator implements Comparator<Processo>, Serializable
   {
      ...
      @Override
      public int compare(final Processo p1, final Processo p2)
      {
